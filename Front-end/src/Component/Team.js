...
const Team = () => {
    return (
     <>
            {/* Team Start */}
            <div className="container-fluid p-5" style={{ background: 'rgba(192, 192, 192, .9)' }}>
                <div className="mb-5 text-center">
                    <h5 className="text-primary text-uppercase">The Team</h5>
                    <h1 className="display-3 text-black text-uppercase mb-0" style={{ background: 'rgba(128, 128, 128, .9)' }} >Expert Trainers</h1>
                </div>
                <div className="row g-5">
                    <div className="col-lg-4 col-md-6">
                        <div className="team-item position-relative">
                            ...
                            <div className="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style={{ background: 'rgba(34, 36, 41, .9)' }}>
                                <h5 className="text-uppercase text-light">Rehana</h5>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="team-item position-relative">
                            ...
                            <div className="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style={{ background: 'rgba(34, 36, 41, .9)' }}>
                                <h5 className="text-uppercase text-light">James</h5>
                                <p className="text-uppercase text-secondary m-0">Trainer</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="team-item position-relative">
                            ...
                            <div className="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style={{ background: 'rgba(34, 36, 41, .9)' }}>
                                <h5 className="text-uppercase text-light">Adam</h5>
                                <p className="text-uppercase  text-secondary m-0">Trainer</p>
                            </div>
                        </div>
                    </div>
